    ...
    <div className="flex flex-col gap-[40px] text-[#A0A0A0]" ref={containerRef}>
      ...
      {isMobile.current ? (
        ...
        <div className="w-fit h-fit flex justify-center items-center">
          ...
          <div
            className={`transition-all ease-in-out duration-[500ms] overflow-hidden ${
              toggle ? 'w-[6.5vw] h-[6.5vw] mx-[30px] min-w-[70px] min-h-[70px]' : 'w-0 h-0 mx-[20px] min-w-[0px] min-h-[0px]'
            } transform ${toggle ? 'scale-110' : 'scale-0'} transform-origin-center`}
          >
            <div className="w-fit h-fit">
              <div className="min-w-[70px] min-h-[70px] w-[6.5vw] h-[6.5vw] rounded-[5px] overflow-hidden">
                <Image
                  src={currentImage}
                  alt="Sunset"
                  width={128}
